				...
				<div class="content-wrapper">
					...
					<div class="card">
						<div class="card-body">
							...
							<form class="form-sample" action="./TransferAmtFunc"
								method="post" modelAttribute="TransferAmtFunc">
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<label class="col-sm-4 col-form-label">Receiver account</label>
										<div class="form-group row">
											<div class="col-sm-9">
												<input type="text" name="rec_ac_no" size="20"
													class="form-control">
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div class="form-group row">
											<div class="col-sm-9">
												<input type="number" name="amount" size="20"
													class="form-control">
											</div>
										</div>
									</div>
